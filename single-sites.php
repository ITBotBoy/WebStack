                        ...
                        <div class="row">
	    					...
	    					<div class="col-12 col-sm-8 col-lg-5 mt-4 mt-md-0">
	    						<div class="site-body p-xl-4">
                                    ...
                                    ?>
                                    <h2 class="site-name h3"><?php echo $sitetitle ?></h2>
                                    <div class="mt-2">
                                        ...
                                        <?php endif; ?>
                                        <a href="javascript:" class="btn btn-arrow"  data-toggle="tooltip" data-placement="bottom" title="" data-html="true" data-original-title="<img src='<?php echo $qrurl ?>' width='150' alt='<?php echo $sitetitle ?>' title='<?php echo $sitetitle ?>'>"><span><?php echo $qrname ?><i class="fa fa-qrcode"></i></span></a>
	    								</div>
	    							</div>
